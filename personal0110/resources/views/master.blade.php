...
<head>
    ...
    <!-- Site title -->
    <title>Nguyễn Phan Anh Thư | Trang chủ</title>
...
<body>
                    ...
                    <div class="mainmenu">
                        <div class="navbar navbar-nobg">
                            <div class="navbar-header">
                                <a class="navbar-brand" href="index-2.html">Reju</a>
                            ...
                            <div class="navbar-collapse collapse">
                                <nav>
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li><a class="smooth_scroll" href="#service">Tin tức</a></li>
        ...
        <div class="table">
            <div class="table-cell">
                    ...
                    <div class="col-md-8 col-md-offset-2 caption">
                        <h4>Hello, I'm Anh Thu</h4>
                        <h1>Desktop Software Engineer</h1>
                        <a class="btn dark smooth_scroll" href="#work">Tin tức</a>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        <h2>ABOUT ME</h2>
                        <p>Quick details about myself.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    <div class="about-text">
                        <h4>Aman Ullah</h4>       
                        <p>Coderspoint has everything you need to get your new website up and running in no time! All of the templates and themes on Coderspoint w3c valid error free code and easy to use. Coderspoint has everything you need to get your new website up and running in no time! All of the templates and themes on Coderspoint w3c valid error free code and easy to use.</p>


                        <ul class="contact-info">
                            <li>
                                <i class="fa fa-map-marker"></i>
                                <p>3066 Stone Lane, Wayne, Pennsylvania.</p>
                            </li>
                            <li>
                                <i class="fa fa-phone"></i>
                                <p>+610-401-6021, +610-401-6022</p>
                            </li>
                            <li>
                                <i class="fa fa-send"></i>
                                <p>admin@mydomain.com</p>
                            </li>
                            <li>
                        ...
                        <a class="btn smooth_scroll" href="#contact">Hire Me Now</a>
    ...
    <!-- Process area starts -->
    <div id="process" class="process-area img-bg section">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        <h2>My Working Process</h2>                        
                        <p>Quick view about how I work.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 process-box">
                    <div class="number">01</div>
                    <h4>Interview</h4>
                    <p>First we have held meeting to discuss details about project with our Client.</p>
                </div>
                
                <div class="col-md-3 col-sm-6 process-box">
                    <div class="number">02</div>
                    <h4>Analysis</h4>
                    <p>We take a survey to analysis properly how the project should build to.</p>
                </div>
                
                <div class="col-md-3 col-sm-6 process-box">
                    <div class="number">03</div>
                    <h4>Development</h4>
                    <p>Web bean have strongest development team. We start developing after analysis.</p>
                </div>
                
                <div class="col-md-3 col-sm-6 process-box last">
                    <div class="number">04</div>
                    <h4>Support</h4>
                    <p>Web bean provides 24/7 Support to make you 100% satisfied taking our services.</p>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="portfolio">
                <div class="row work-items">
                    ...
                    <!-- work item -->
                    <div class="col-md-3 col-sm-6 mix web">
                        <div class="item">
                            <a href="assets/img/works/1.png" class="work-popup">
                    ...
                    <!-- work item -->
                    <div class="col-md-3 col-sm-6 mix app">
                        <div class="item">
                            <a href="assets/img/works/2.png" class="work-popup">
                    ...
                    <!-- work item -->
                    <div class="col-md-3 col-sm-6 mix typography web">
                        <div class="item">
                            <a href="assets/img/works/3.png" class="work-popup">
                    ...
                    <!-- work item -->
                    <div class="col-md-3 col-sm-6 mix web app graphic">
                        <div class="item">
                            <a href="assets/img/works/4.png" class="work-popup">
                    ...
                    <div class="col-md-3 col-sm-6 mix web">
                        <div class="item">
                            <a href="assets/img/works/5.png" class="work-popup">
                                <img src="assets/img/works/5.png" alt="">
                                <div class="overlay">
                                    <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                                </div>
                            </a>
                    ...
                    <!-- work item -->
                    <div class="col-md-3 col-sm-6 mix app graphic">
                        <div class="item">
                            <a href="assets/img/works/6.png" class="work-popup">
                                <img src="assets/img/works/6.png" alt="">
                                <div class="overlay">
                                    <i class="fa fa-arrows-alt" aria-hidden="true"></i>
                                </div>
                            </a>
            ...
            <div class="row">
                <div class="testimonial-list">
                    ...
                    <div class="single-testimonial text-center">
                        ...
                        <p class="text-left">Coderspoint has everything you need to get your new website up and running in no time! All of the templates and themes on Coderspoint w3c valid error free code and easy to use. We provide good support.</p>
                    ...
                    <div class="single-testimonial text-center">
                        <i class="fa fa-quote-left"></i>
                        <img src="assets/img/testimonial/1.jpg" alt="">
                        <p class="text-left">Coderspoint has everything you need to get your new website up and running in no time! All of the templates and themes on Coderspoint w3c valid error free code and easy to use.</p>
                        <div class="clearfix"></div>
                        <h3>John doe</h3>
                        <p class="desg">Founder of Coderspoint</p>
                    </div>
